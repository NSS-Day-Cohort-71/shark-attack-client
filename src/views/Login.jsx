...
export const Login = () => {
    const [email, setEmail] = useState("jenna@solis.com")
    const [password, setPassword] = useState("solis")
    ...
    const handleLogin = (e) => {
        ...
        fetch(`http://localhost:8000/login`, {
            ...
            .then(authInfo => {
                if (authInfo.token) {
                    localStorage.setItem("shark_token", JSON.stringify(authInfo))
                    navigate("/")
                } else {
        ...
        <main className="container--login">
            ...
            <section>
                <form className="form--login" onSubmit={handleLogin}>
                    <h1 className="text-4xl mt-7 mb-3">Shark Attack Dive Shop</h1>
